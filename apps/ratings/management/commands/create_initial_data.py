...
from apps.ratings.models import BaseDocument, SignerText, RatingComponent, \
    MonthlyRating
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if RatingComponent.objects.count() > 0:
            raise CommandError("Rating components already created!")
        RatingComponent.objects.create(
            number=1,
