    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('generated_excel', models.FileField(blank=True, null=True, upload_to='')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('best_type', models.SmallIntegerField(choices=[(1, 'мин'), (2, 'макс')], null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('document', models.FileField(blank=True, null=True, upload_to='uploads/%Y/%m/%d/documents/')),
                ('display_type', models.SmallIntegerField(choices=[(1, 'десятичное число'), (2, 'процент')], default=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value', models.DecimalField(blank=True, decimal_places=5, max_digits=8, null=True)),
