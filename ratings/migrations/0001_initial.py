# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-02-25 03:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('monthly_rating_sub_component', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='related_values', to='ratings.MonthlyRatingSubComponent')),
        ...
        migrations.AddField(
            model_name='monthlyratingsubcomponent',
            name='responsible',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='employees.PrefectureEmployee'),
        ),
        migrations.AddField(
