...
from common.permissions import NegotiatorOnlyPermission, \
    ResponsibleOnlyPermission, SubComponentPermission
from common.response_wrappers import bad_request_response
from ratings.models import MonthlyRating, MonthlyRatingComponent, \
