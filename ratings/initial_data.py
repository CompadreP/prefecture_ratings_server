...
def add_base_rating_components(self, schema_editor):
    ...
    manager.create(
        ...
        base_description='Показатель формироуется по еженедельным отчетам ГКУ "Дирекция ЖКХиБ САО" в рамках подготовки к тепловой комиссии на основании базы АСУ ЕИРЦ.',
        weight=10,
        sub_components_display_type=1,
        valid_from_month=1,
        valid_from_year=2016,
